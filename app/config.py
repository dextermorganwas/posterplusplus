...
class Settings:
    ...
    sash_font_ratio: float=env_float("SASH_FONT_RATIO",0.052)
    sash_min_font_ratio: float=env_float("SASH_MIN_FONT_RATIO",0.040)
    ...
    sash_tab_width_ratio: float=env_float("SASH_TAB_WIDTH_RATIO",0.38)
